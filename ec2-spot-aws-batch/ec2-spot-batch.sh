...
docker build --no-cache  -t ec2-spot-batch  .
docker tag ec2-spot-batch:latest 000474600478.dkr.ecr.us-east-1.amazonaws.com/ec2-spot-batch:latest

 docker push 000474600478.dkr.ecr.us-east-1.amazonaws.com/ec2-spot-batch:latest

aws batch register-job-definition --cli-input-json file://ec2-spot-batch-job-definition.json
